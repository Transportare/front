...
export class DetalleComponent implements OnInit, OnDestroy {
    ...
    detalle(id) {
        this.router.navigate([`${RUTAS_OPERACIONES_PAQUETERIA.ruta.init}/${id}/${RUTAS_OPERACIONES_PAQUETERIA.ruta.detalle}`]);
    }

    atras() {
        this.router.navigate([`${RUTAS_OPERACIONES_PAQUETERIA.clientes.init}`]);
    }
}
